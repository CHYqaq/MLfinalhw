...
# 使用新的训练方法
def train_model(model, train_loader, epochs, learning_rate=0.001, save_path='checkpoints', print_freq=100, save_freq=10000):
    model.train()
...
for ratio in ratio_sizes:
    ...
    # 训练模型
    train_loss, all_loss = train_model(model, train_loader, epochs=1, learning_rate=0.001, save_path='checkpoints', print_freq=100, save_freq=10000)
